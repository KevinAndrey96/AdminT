...
<head>
    ...
    <meta name="description" content="<?=$Nombre_Sitio?>">
                ...
                <div class="login-logo">
                    ...
                    <div class="login-form">
                        <form action="Controller/Login.php" method="POST">
                            ...
                            <button type="submit" style="background-color: #00b0f4" class="btn btn-success btn-flat m-b-30 m-t-30">Iniciar Sesión</button>
                            <br>
                            <br>
                            <!--<div style="display: none;" class="register-link m-t-15 text-center">
