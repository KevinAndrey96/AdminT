...
?>
            ...
            <div class="form-group">
              <label>Código</label>
              <input type="text" class="form-control"  name="SHORT" placeholder="Código" required>
            </div>
            <div class="form-group">
  ...
  <!--<div class="col-md-6">
    <div class="card" id="EditarProd" style="display: none;">
      <div class="card-header">
        ...
        <div class="login-form" id="LOGPROD" >
          <form action="Controller/UpdateProduct.php" method="POST">
            ...
            <!--<div style="" class="form-group">
              ...
              <select title="Fotografías" class="selectpicker form-control" name="PHOTOS[]" multiple>
              <?php
              $Q="SELECT * FROM `wp_posts` where post_type='attachment' and (post_mime_type='image/jpeg' or post_mime_type='image/png') order by ID DESC";
              foreach ($db->query($Q) as $Row) {
                $Nom=$Row["post_title"];
                $guid=$Row["guid"];
                $id=$Row["ID"]
            ...
            <div class="form-group" style="display: none;">
              <label>Foto</label>
              <center><img src="https://disproarte.com/Tienda/wp-content/uploads/woocommerce-placeholder-600x600.png" onError="this.onerror=null;this.src='https://disproarte.com/Tienda/wp-content/uploads/woocommerce-placeholder-600x600.png';" id="foto" height="50px" width="50px"></center>
              <br>
              
            </div>
            <div class="form-group">
              <label>Código</label>
              <input type="text" class="form-control" id="short" name="SHORT" placeholder="Código" required>
            </div>
            <div class="form-group">
              <label>Descripción larga</label>
...
foreach ($db->query($Q) as $Row) {
  ...
  foreach ($db->query($Q1) as $Row1) {
	...
	{
		?>
			<option value="<?=$tid?>" selected><?=$Row1["name"]?></option>
	    <?php
	}
  }
}
